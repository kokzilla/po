        ...
        <div class="panel panel-success" id="personal-data">
            ...
            <div class="panel-body">
                <div class ="row">
                        ...
                        <div class="row">       
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text(null,null, array('class' => 'form-control','size' =>'5','maxlength'=>'10')) !!}
                                </div>
                                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <img src="/images/noimage.png" class="img-responsive" alt="Responsive image" width="50%" height="50%">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-2">
                        {!! Form::label(null, 'บัตรประชาชน') !!}
                    </div>
                    <div class="col-md-10">
                        <div class="form-group">                            
                            {!! Form::text(null,null, array('class' => 'form-control' ,'maxlength'=>'13' ,'placeholder' => 'เลขที่บัตร')) !!}
                        </div>
                        <div class="form-group">

                            <div class='input-group date' id='datetimepicker2'>
                                <input type='text' class="form-control" placeholder="บัตรหมดอายุ"/>
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        {!! Form::label('province', 'ที่อยู่ตามบัตรประชาชน') !!}
                    </div>
                    <div class="col-md-10">
                        <div class="form-group">

                                {!! Form::text(null,null, array('class' => 'form-control fulladdress')) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            {!! Form::select(null, $marriages,null, array('class' => 'form-control')) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            {!! Form::text(null,null, array('class' => 'form-control fullname')) !!}
                        </div>	
                        <div class="form-group">
                            {!! Form::label('spouse_age', 'อายุ:') !!}
                            {!! Form::text(null,null, array('class' => 'form-control age')) !!}
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            {!! Form::text(null,null, array('class' => 'form-control num')) !!}
                        </div>		
                    </div>
                </div>
                <div class="row">
